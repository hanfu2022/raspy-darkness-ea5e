...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-darkness-ea5e)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-darkness-ea5e
```

A live public deployment of this template is available at [https://raspy-darkness-ea5e.templates.workers.dev](https://raspy-darkness-ea5e.templates.workers.dev)
